...
function t(){this._nowUnique=0}
return t.prototype.now=function(){
return Math.max(this._nowUnique,Date.now())
},t.prototype.nowUnique=function(){
var t=this.now()+1;return this._nowUnique=t,t
},t.prototype.setTimeout=function(t,e){
return setTimeout(t,e)
},t.prototype.clearTimeout=function(t){
clearTimeout(t)},t}(),n=new e;function i(t,e){
return t<e}class o{
constructor({objectPool:t,lessThanFunc:e}={}){
this._size=0,this._root=null,this.merge=r,
this.collapse=l,this._objectPool=t,this._lessThanFunc=e||i
...
;if(t===this._root)this._root=l(t.child,this._lessThanFunc);else{
if(null==t.prev){
...
this._root=r(this._root,l(t.child,this._lessThanFunc),this._lessThanFunc)
}
...
;return function*n(i){
i&&(t?yield i:yield i.item,i.child&&(null!=i.child.next&&(i.child=l(i.child,e),
...
i.next=null,i.prev=null,i)}function l(t,e){
...
this._now=1,this._nowUnique=0,this._nextId=0,this._handles=new o({
lessThanFunc:s})}
return Object.defineProperty(t.prototype,"queueSize",{
get:function(){return this._handles.size},
enumerable:!1,configurable:!0
}),Object.defineProperty(t.prototype,"nextQueuedTime",{
get:function(){var t,e
;return null!==(e=null===(t=this._handles.getMin())||void 0===t?void 0:t.time)&&void 0!==e?e:null
},enumerable:!1,configurable:!0
...
;t.TimeControllerDefault=e,t.TimeControllerMock=u,t.timeControllerDefault=n,
